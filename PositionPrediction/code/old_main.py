...
class FitAndPredict:
    ...
    def read_train_data(self):
        ...
        try:
            self.input_data = pd.read_csv(self.train_file)
    ...
    def check_test_data(self):
        ...
        try:
            ...
            pass
        try:
            if (set(self.map_sensors.keys()).issubset(set(test_columns))) or \
            (set(self.map_sensors.values()).issubset(set(test_columns))):
                pass
            else:
                print ("LOAD CELL COLUMNS NOT PRESENT IN TEST DATA")
                logging.debug(__name__ + ' : ' + ' LOAD CELL COLUMNS NOT PRESENT IN TEST DATA')
                logging.debug(__name__ + ' : ' + ' End read_test_data()')
                sys.exit()
        except Exception as e:
            logging.error(__name__ + ' : ' + ' Error: ' + str(e))
    ...
    def preprocess_test_data(self):
        ...
        #try:
        #    self.preprocessed_test_data = self.preprocess.rem_load_cell_threshold(self.preprocessed_test_data)
        #except Exception as e:
        #    logging.error(__name__ + ' : ' + ' Error: ' + str(e))
        #finally:
        #    pass
        ...
        #try:
        #    self.preprocessed_test_data = self.preprocess.rem_less_weights(self.preprocessed_test_data)
        #except Exception as e:
        #    logging.error(__name__ + ' : ' + ' Error: ' + str(e))
        #finally:
        #   pass
    ...
    def classify(self):
        ...
        try:
            ...
            self.predicted_test_data = pd.DataFrame({self.target_column:predictions})
            self.predicted_test_data.to_csv(self.predicted_test_file, index = False)
