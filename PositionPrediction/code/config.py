...
# PARENT_FOLDER = os.path.abspath(os.path.join(cur_dir, '/home/pi/PositionPrediction/'))
...
TRAIN_FILE_NAME = "train_data_20190319.csv"
...
PREDICTED_TEST_FILE = os.path.abspath(
    os.path.join(TEST_FOLDER, PREDICTED_TEST_FILE_NAME)
)
...
LOAD_CELL_THRESHOLD = (
    50  # to remove readings with load cell readings greater than load_cell_threshold
)
WEIGHT_THRESHOLD = (
    40  # remove readings whose total weight is less than weight threshold
)
...
DEV_MAP = {"positive_high": 3, "on": 2, "negative_high": 1}
